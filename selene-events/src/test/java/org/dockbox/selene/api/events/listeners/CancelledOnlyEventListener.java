...
import org.dockbox.selene.api.events.SampleCancellable;
import org.dockbox.selene.api.events.annotations.IsCancelled;
import org.dockbox.selene.api.events.annotations.Listener;

public class CancelledOnlyEventListener {

    public static boolean fired = false;

    @Listener
    @IsCancelled(Tristate.TRUE)
    public void on(SampleCancellable event) {
        CancelledOnlyEventListener.fired = true;
    }
