...
public class TicketOpenCommand
    ...
    /*if (!(src instanceof Player)) {
        ...
        if (src instanceof Player) {
            ...
            if (plot != null) {
                try {
                    ...
                    if (TicketConfig.staffNotification)
                        PlayerUtils.broadcastForPermission(Translations.TICKET_OPEN
                                .ft(player.getName(), ticketID), Permissions.TICKET_STAFF
                                .p());
                    ...
                    embedBuilder.addField(
                            ...
                            Translations.TICKET_DISCORD_NEW_COMBINED
                                    .f(ticketID, message, LocalDateTime.now().toString()),
                            false);
            ...
            try {
                ...
                if (TicketConfig.staffNotification) {
                    PlayerUtils.broadcastForPermission(Translations.TICKET_OPEN.ft(Translations.CONSOLE
                            .s(), ticketID), Permissions.TICKET_STAFF
                            .p());
                }
            } catch (Exception e) {
