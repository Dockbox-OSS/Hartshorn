...
public final class DefaultArgumentConverters implements InjectableType {
    ...
    public static final ArgumentConverter<String> STRING =
            new CommandValueConverter<>(
                    String.class, (Function<String, Exceptional<String>>) Exceptional::ofNullable, "string");

    public static final ArgumentConverter<Character> CHARACTER =
            new CommandValueConverter<>(
                    Character.class,
                    in -> {
    ...
    public static final ArgumentConverter<Boolean> BOOLEAN =
            new CommandValueConverter<>(
                    Boolean.class,
                    in -> {
                        switch (in) {
    ...
    public static final ArgumentConverter<Double> DOUBLE =
            new CommandValueConverter<>(
                    Double.class, in -> Exceptional.of(in).map(Double::parseDouble), "double");

    public static final ArgumentConverter<Float> FLOAT =
            new CommandValueConverter<>(
                    Float.class, in -> Exceptional.of(in).map(Float::parseFloat), "float");

    public static final ArgumentConverter<Integer> INTEGER =
            new CommandValueConverter<>(
                    Integer.class, in -> Exceptional.of(in).map(Integer::parseInt), "int", "integer");

    public static final ArgumentConverter<Long> LONG =
            new CommandValueConverter<>(
                    Long.class, in -> Exceptional.of(in).map(Long::parseLong), "long");

    public static final ArgumentConverter<Short> SHORT =
            new CommandValueConverter<>(
                    Short.class, in -> Exceptional.of(in).map(Short::parseShort), "short");

    public static final ArgumentConverter<Language> LANGUAGE =
            new CommandValueConverter<>(
                    Language.class,
                    (@NonNls String in) -> {
                        Language lang;
    ...
    public static final ArgumentConverter<UUID> UNIQUE_ID =
            new CommandValueConverter<>(
                    UUID.class, in -> Exceptional.of(() -> UUID.fromString(in)), "uuid", "uniqueid");

    public static final ArgumentConverter<Vector3N> VECTOR =
            new CommandValueConverter<>(
                    Vector3N.class,
                    in ->
                            Exceptional.of(
    ...
    public static final ArgumentConverter<World> WORLD =
            new CommandValueConverter<>(
                    World.class,
                    in -> {
    ...
    public static final ArgumentConverter<Location> LOCATION =
            new CommandValueConverter<>(
                    Location.class,
                    (cs, in) -> {
    ...
    public static final ArgumentConverter<ResourceEntry> RESOURCE =
            new CommandValueConverter<>(
                    ResourceEntry.class,
                    in -> {
    ...
    public static final ArgumentConverter<Player> PLAYER =
            new CommandValueConverter<>(
                    Player.class,
                    in -> {
    ...
    public static final ArgumentConverter<Duration> DURATION =
            new CommandValueConverter<>(Duration.class, SeleneUtils::durationOf, "duration");

    public static final ArgumentConverter<Module> MODULE =
            new CommandValueConverter<>(
                    Module.class,
                    in -> Selene.provide(ModuleManager.class).getHeader(in),
                    in ->
    ...
    public static final ArgumentConverter<Text> TEXT =
            new CommandValueConverter<>(Text.class, in -> Exceptional.of(Text.of(in)), "text");
