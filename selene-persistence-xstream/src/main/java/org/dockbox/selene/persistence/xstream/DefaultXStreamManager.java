...
import org.dockbox.selene.persistence.xstream.util.XStreamUtils;
import org.dockbox.selene.persistence.xstream.util.XStreamUtils.XStreamBuilder;
...
public abstract class DefaultXStreamManager extends DefaultAbstractFileManager {
    ...
    public void requestFileType(FileType fileType) {
        if (FileType.XML != fileType) throw new UnsupportedOperationException("XStream only supports XML");
    }
