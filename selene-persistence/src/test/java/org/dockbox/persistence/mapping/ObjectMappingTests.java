...
package org.dockbox.persistence.mapping;

import org.dockbox.persistence.Element;
import org.dockbox.persistence.EntityElement;
import org.dockbox.persistence.MultiElement;
import org.dockbox.persistence.NestedElement;
import org.dockbox.persistence.PersistentElement;
import org.dockbox.selene.api.domain.Exceptional;
import org.dockbox.selene.persistence.FileType;
import org.dockbox.selene.persistence.mapping.JacksonObjectMapper;
...
public class ObjectMappingTests {
    ...
    void testObjectSerialisation(FileType fileType, Element content, String expected) {
        ...
        Assertions.assertEquals(SeleneUtils.strip(expected), SeleneUtils.strip(result.get()));
    }
