...
/**
 * An abstract {@link ParameterLoaderRule} that loads parameter values from a {@link WebRequest}
 * based on a specific parameter annotation.
 *
...
public abstract class AbstractWebRequestParameterLoaderRule<
     ...
     */
    protected abstract Option<String> lookupValue(WebRequest request, A annotation);
