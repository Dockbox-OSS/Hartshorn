...
public class PathParameterValueParameterLoaderRule<C extends ParameterLoaderContext>
    ...
    @Override
    protected Option<String> lookupValue(HttpServletRequest request, PathParameter annotation) {
        Map<String, String> parameters = RequestAttributes.pathParameters(request);
        return Option.of(parameters.get(annotation.value()));
    }
