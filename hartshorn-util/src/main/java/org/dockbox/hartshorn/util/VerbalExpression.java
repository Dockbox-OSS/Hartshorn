...
public final class VerbalExpression {
    ...
    /**
     * Use builder {@link #regex()} (or {@link #regex(VerbalExpression.Builder)}) to create new
     * instance of VerbalExpression
     *
     * @param pattern
     ...
     *
     * <p>Example is see to {@link Builder#capture(String)}
     *
     * @param toTest
     *         - string to extract from
     * @param group
    ...
    public static class Builder {
        ...
        private static final Map<Character, Integer> SYMBOL_MAP = HartshornUtils.ofEntries(
                HartshornUtils.entry('d', Pattern.UNIX_LINES),
                HartshornUtils.entry('i', Pattern.CASE_INSENSITIVE),
                HartshornUtils.entry('x', Pattern.COMMENTS),
                HartshornUtils.entry('m', Pattern.MULTILINE),
                HartshornUtils.entry('s', Pattern.DOTALL),
                HartshornUtils.entry('u', Pattern.UNICODE_CASE),
                HartshornUtils.entry('U', Pattern.UNICODE_CHARACTER_CLASS));
        ...
        /**
         * Mark the expression to start at the beginning of the line Same as {@link
         * #startOfLine(boolean)} with true arg
         *
         * @return this builder
         */
        ...
        /**
         * Mark the expression to end at the last character of the line Same as {@link
         * #endOfLine(boolean)} with true arg
         *
         * @return this builder
         */
        ...
        /**
         * Add a string to the expression Syntax sugar for {@link #then(String)} - use it in case:
        ...
        /**
         * Append literal expression Everything added to the expression should go trough this method
         * (keep in mind when creating your own methods). All existing methods already use this, so for
         * basic usage, you can just ignore this method.
         *
         * <p>Example: regex().add("\n.*").build() // produce exact "\n.*" regexp
         *
         * @param pValue
        ...
        /**
         * Escapes any non-word char with two backslashes used by any method, except {@link
         * #add(String)}
         *
         * @param pValue
        ...
        /**
         * Add a string to the expression that might appear once (or not) Example: The following matches
         * all strings that contain http:// or https:// VerbalExpression regex = regex() .find("http")
         * .maybe("s") .then("://") .anythingBut(" ").build(); regex.test("http://") //true
        ...
        /**
         * Add a regex to the expression that might appear once (or not) Example: The following matches
         * all names that have a prefix or not. VerbalExpression.Builder namePrefix =
         * regex().oneOf("Mr.", "Ms."); VerbalExpression name = regex() .maybe(namePrefix) .space()
         * .zeroOrMore() .word() .oneOrMore() .build(); regex.test("Mr. Bond/") //true
    ...
    */
         ...
         * ]) Example: The following matches a hexadecimal number: regex().range( "0", "9", "a", "f") //
         * produce [0-9a-f]
         *
         * @param pArgs
         *         - pairs for range
        ...
        /**
         * Turn ON matching with ignoring case Example: // matches "a" // matches "A"
        ...
        /**
         * Convenient method to show that string usage count is exact count, range count or simply one
         * or more Usage: regex().multiply("abc") // Produce (?:abc)+ regex().multiply("abc", null) //
         * Produce (?:abc)+ regex().multiply("abc", (int)from) // Produce (?:abc){from}
        ...
        /**
         * Adds "+" char to regexp Same effect as {@link #atLeast(int)} with "1" argument Also, used by
         * {@link #multiple(String, int...)} when second argument is null, or have length more than 2
         *
         * @return this builder
         * @since 1.2
         */
        ...
        /**
         * Adds "*" char to regexp, means zero or more times repeated Same effect as {@link
         * #atLeast(int)} with "0" argument
         *
         * @return this builder
         * @since 1.2
         */
        ...
        /**
         * Counts occurrences of some substring in whole string Same as
         * org.apache.commons.lang3.StringUtils#countMatches(String, java.lang.String) by effect. Used
         * to count braces for {@link #or(String)} method
         *
         * @param where
         *         - where to find
         * @param what
        ...
        /**
         * Same as {@link #capture()}, but don't save result May be used to set count of duplicated
         * captures, without creating a new saved capture Example: // Without group() - count(2) applies
         * only to second capture regex().group() .capt().range("0", "1").endCapt().tab()
        ...
        /**
         * Close brace for previous capture and remove last closed brace from suffixes Can be used to
         * continue build regex after capture or to add multiply captures
         *
         * @return this builder
         */
        ...
        /**
         * Closes current unnamed and unmatching group Shortcut for {@link #endCapture()} Use it with
         * {@link #group()} for prettify code Example: regex().group().maybe("word").count(2).endGr()
         *
         * @return this builder
         * @since 1.2
         */
