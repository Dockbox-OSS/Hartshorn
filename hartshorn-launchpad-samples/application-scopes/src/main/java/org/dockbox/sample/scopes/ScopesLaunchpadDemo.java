...
public class ScopesLaunchpadDemo {
    ...
    private static void globalScopeDemonstration(Logger logger, ApplicationContext applicationContext) {
        ...
        ComponentWithMessage componentWithDefaultMessage = applicationContext.get(ComponentWithMessage.class);
        logger.info("Component with default message: {}", componentWithDefaultMessage.message());
    }

    private static void customScopeDemonstration(Logger logger, ApplicationContext applicationContext) {
        ...
        ComponentWithMessage componentWithScopedMessage = applicationContext.get(ComponentKey.builder(ComponentWithMessage.class)
                .scope(customMessageScope)
                .build());
        logger.info("Component with scoped message: {}", componentWithScopedMessage.message());
    }

    private static void secondCustomScopeDemonstration(Logger logger, ApplicationContext applicationContext) {
        ...
        // own scope instance.
        CustomMessageScope secondCustomMessageScope = new CustomMessageScope("another custom scope");
