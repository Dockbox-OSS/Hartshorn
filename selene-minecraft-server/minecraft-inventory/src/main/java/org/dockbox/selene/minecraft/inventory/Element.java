 ...
 * org.dockbox.selene.minecraft.inventory.pane.Pane} instance. A element can either be a static
...
public interface Element {
    ...
    static Element of(Item item, Consumer<Player> onClick) {
        return Selene.provide(SeleneFactory.class).create(Element.class, item, onClick);
    }
