...
public abstract class UserRepository implements JpaRepository<User, Long> {
     ...
     * After the {@link User} is created, it is saved to a configured {@link JpaRepository}, which is configured
     * through the {@link org.dockbox.hartshorn.core.binding.Provider} method {@link org.dockbox.hartshorn.demo.persistence.PersistenceDemoConfiguration#sql(ApplicationContext)}.
