...
public abstract class UserRepository implements JpaRepository<User, Long> {
     ...
     * This is possible as backing implementations are attached as context to the {@link org.dockbox.hartshorn.core.proxy.ProxyHandler}
     * responsible for this {@link JpaRepository}.
     *
    ...
    public void save(final User object) {
        this.applicationContext().environment().application()
                .delegator(TypeContext.of(JpaRepository.class), this)
                .get().save(object);
