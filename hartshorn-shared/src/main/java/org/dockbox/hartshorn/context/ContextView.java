...
public interface ContextView {
    ...
    /**
     * Returns all contexts of the given type. If no contexts of the given type are found, an empty
     * list is returned.
     *
     * @param context The type of the context.
    ...
    /**
     * Returns the first context matching the given identity. If no context is found, an attempt may
     * be made to create a new context using the fallback function of the identity. If no fallback
     * function is present, or it is not compatible with the current context, an empty option is
     * returned.
     *
    ...
    /**
     * Returns all contexts matching the given identity. If no contexts are found, an empty list is
     * returned.
     *
     * @param key The identity of the context.
    ...
    /**
     * Copies all child contexts from the current context to the given context. This will not copy
