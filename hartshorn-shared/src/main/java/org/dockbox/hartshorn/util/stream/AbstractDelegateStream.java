...
/**
 * An abstract implementation of a {@link Stream} that delegates all calls to a wrapped {@link
 * Stream}. This allows for easy extension of the {@link Stream} interface without having to
