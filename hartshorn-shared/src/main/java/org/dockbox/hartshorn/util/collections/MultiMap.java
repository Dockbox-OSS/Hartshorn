...
public interface MultiMap<K, V> extends Iterable<Map.Entry<K, Collection<V>>> {
    ...
    /**
     * Returns all values in this {@link MultiMap}. The returned {@link Collection} is a copy of the
     * values in this {@link MultiMap}, so changes to the returned {@link Collection} will not be
     * reflected in this {@link MultiMap}.
     *
     * <p>The returned {@link Collection} is not guaranteed to be ordered in any way, and may
    ...
    /**
     * Adds all values in the given {@link Collection} to the given key. If the key already exists
     * in this {@link MultiMap}, the values in the given {@link Collection} are added to the
     * existing values. If the key does not exist in this {@link MultiMap}, the key is added to this
     * {@link MultiMap} and the values in the given {@link Collection} are added to the newly
     * created entry.
     *
    ...
    /**
     * Adds all entries in the given {@link MultiMap} to this {@link MultiMap}. If a key already
     * exists in this {@link MultiMap}, the values in the given {@link MultiMap} are added to the
     * existing values. If a key does not exist in this {@link MultiMap}, the key is added to this
     * {@link MultiMap} and the values in the given {@link MultiMap} are added to the newly created
     * entry.
     *
    ...
    /**
     * Returns the values associated with the given key, or an empty {@link Collection} if the key
    ...
    /**
     * Returns the set of keys in this {@link MultiMap}. The returned {@link Set} is a copy of the
     * keys in this {@link MultiMap}, so changes to the returned {@link Set} will not be reflected
     * in this {@link MultiMap}.
     *
    ...
    /**
     * Returns the set of entries in this {@link MultiMap}. The returned {@link Set} is a copy of
     * the entries in this {@link MultiMap}, so changes to the returned {@link Set} will not be
     * reflected in this {@link MultiMap}.
     *
    ...
    /**
     * Returns the values in this {@link MultiMap}. The returned {@link Collection} is a copy of the
     * values in this {@link MultiMap}, so changes to the returned {@link Collection} will not be
     * reflected in this {@link MultiMap}.
     *
    ...
    /**
     * Returns the number of values in this {@link MultiMap}. If a key is associated with multiple
     * values, each value is counted separately.
     *
    ...
    /**
     * Returns whether this {@link MultiMap} is empty. If a key is in the map, but has no values
     * associated with it, the key is still counted as being in the map.
     *
    ...
    /**
     * Removes the given value from the given key. If the key is in this {@link MultiMap} but the
     * value is not, this method does nothing.
     *
     * @param key the key
     * @param value the value
    ...
    /**
     * Replaces the given old value with the given new value in the given key. If the key is in this
     * {@link MultiMap} but the old value is not, this method does nothing.
     *
     * @param key the key
    ...
    /**
     * Iterates over all entries in this {@link MultiMap} and calls the given {@link BiConsumer} for
     * each entry.
     *
    ...
    /**
     * Creates a new {@link MultiMapBuilder} which can be used to create a new {@link MultiMap} with
