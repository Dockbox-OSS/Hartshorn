...
/**
 * A {@link MultiMap} that can be inverted, meaning that the values become the keys and the keys
 * become the values.
 *
...
public interface BiMultiMap<K, V> extends MultiMap<K, V> {
    ...
    /**
     * Returns the inverse of this {@link BiMultiMap}. The inverse of a {@link BiMultiMap} is
     * another {@link MultiMap} that contains the same entries as the original {@link BiMultiMap},
