 ...
 * value be changed. This is a combination of {@link MutableGraphNode} and {@link
 * ContainableGraphNode}, with added methods to allow the addition of parents.
 *
        ...
        ContainableGraphNode<T>
{
     ...
     * of this node, this method does nothing. If any of the provided nodes is also a {@link
     * MutableGraphNode}, this node is added as a child to the provided node.
     *
