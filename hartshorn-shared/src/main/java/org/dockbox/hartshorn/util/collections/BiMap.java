...
/**
 * A {@link Map} that allows for bidirectional lookup of keys and values. This interface is a subset
...
public interface BiMap<K, V> extends Map<K, V> {
    ...
    /**
     * Creates a new {@link BiMap} with the given {@link java.util.Map.Entry entries} as initial
     * entries.
     *
