...
public interface DiagnosticsReportCollector extends DiagnosticsPropertyCollector {
    ...
    /**
     * Adds the given {@link CategorizedDiagnosticsReporter} to the report. The category of the
     * reporter is used as the name of the node in the report.
     *
    ...
    /**
     * Returns a {@link DiagnosticsReport} that contains the properties that have been collected by
     * this instance. If no properties have been collected, an empty report is returned. Additional
     * properties may also be added to the report.
     *
    ...
    /**
     * Returns a {@link DiagnosticsReport} that contains the properties that have been collected by
     * this instance, appended with the properties of the given {@link Reportable}. Depending on the
     * implementation, the properties of the given {@link Reportable} may be added to the report, or
