...
public interface PermissionHolder extends Identifiable {
    ...
    void setPermission(String permission, org.dockbox.selene.api.domain.tuple.Tristate state);

    void setPermissions(org.dockbox.selene.api.domain.tuple.Tristate state, String... permissions);

    void setPermission(Permission permission, org.dockbox.selene.api.domain.tuple.Tristate state);

    void setPermissions(org.dockbox.selene.api.domain.tuple.Tristate state, Permission... permissions);
}
