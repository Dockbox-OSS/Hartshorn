...
package org.dockbox.hartshorn.sponge.objects.location;
...
public class SpongeWorld extends World implements Wrapper<org.spongepowered.api.world.World>, SpongeDimension {
    ...
    public Collection<Chunk> getLoadedChunks() {
        if (this.referenceExists()) {
            return HartshornUtils.stream(this.getReferenceWorld().getLoadedChunks()).map(SpongeConversionUtil::fromSponge).collect(Collectors.toList());
        }
