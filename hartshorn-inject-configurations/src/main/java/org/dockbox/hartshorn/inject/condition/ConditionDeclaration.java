...
public interface ConditionDeclaration {
     ...
     * {@code false}, the condition matcher will only indicate that the condition does not match.
     *
     * @return {@code true} when the condition matcher should fail when the condition does not
