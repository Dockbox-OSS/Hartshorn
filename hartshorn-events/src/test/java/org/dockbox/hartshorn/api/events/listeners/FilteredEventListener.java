...
import org.dockbox.hartshorn.api.events.SampleFilterableEvent;
...
public class FilteredEventListener {
    ...
    @Listener
    @Filter(param = "name", value = "Hartshorn")
    public void on(SampleFilterableEvent event) {
        FilteredEventListener.fired = true;
    }
