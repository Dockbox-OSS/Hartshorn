...
class DefaultCommandBusTests {
  ...
  public void extendedCommandIsPresent() {
    ...
    Optional<MethodCommandContext> extendedContextOptional =
        inheritanceContext.getInheritedCommands().stream()
            .filter(inheritedContext -> inheritedContext.getAliases().contains("extended"))
            .findFirst();

    Optional<MethodCommandContext> contextOptional =
        inheritanceContext.getInheritedCommands().stream()
  ...
  public void nonInheritedCommandIsNotPresentInParent() {
    ...
    Optional<MethodCommandContext> inheritedCommandContext =
        inheritanceContext.getInheritedCommands().stream()
