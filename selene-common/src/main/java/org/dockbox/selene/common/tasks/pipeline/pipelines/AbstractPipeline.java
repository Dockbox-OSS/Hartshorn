...
import org.dockbox.selene.common.tasks.pipeline.CancelBehaviour;
import org.dockbox.selene.common.tasks.pipeline.exceptions.IllegalPipeException;
import org.dockbox.selene.common.tasks.pipeline.pipes.CancellablePipe;
import org.dockbox.selene.common.tasks.pipeline.pipes.ComplexPipe;
import org.dockbox.selene.common.tasks.pipeline.pipes.IPipe;
import org.dockbox.selene.common.tasks.pipeline.pipes.StandardPipe;
...
public abstract class AbstractPipeline<P, I> {
   ...
   *
   * @param pipeline The non-null {@link AbstractPipeline} whos {@link IPipe}s should be added to
   *     this pipeline
   * @return Itself
   */
   ...
   *
   * @param exceptionalInput A non-null {@link Exceptional} which contains the input value and
   *     throwable
   ...
   * @param exceptionalInput An {@link Exceptional} containing the input to be processed by the
   *     {@link IPipe}
   * @return An {@link Exceptional} of the output of the {@link IPipe}
   * @throws IllegalPipeException If you try and add a {@link CancellablePipe} and the pipeline is
   *     not cancellable
   */
   ...
   *
   * @param inputs The non-null {@link Collection} of {@code P} inputs to be processed by the
   *     pipeline
