...
public class ConvertiblePipeline<P, I> extends AbstractPipeline<P, I>
{
    ...
    /**
     * Sets the cancel behaviour to be used by the entire pipeline by internally calling
     * {@link ConvertiblePipeline#setCancelBehaviour(CancelBehaviour, PipelineDirection)}.
     *
     ...
     * {@link CancellablePipe}s in this pipeline.
     *
     * @param converter
    ...
    /**
     * Propagates the cancel behaviour throughout all the linked pipelines in a particular {@link PipelineDirection}.
     *
     * @param cancelBehaviour
     *         The {@link CancelBehaviour} to be used by the pipeline
     * @param direction
     *         The {@link PipelineDirection} that the cancel behaviour needs to be passed along
     */
