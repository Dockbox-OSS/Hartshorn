...
import org.dockbox.selene.common.tasks.pipeline.PipelineDirection;
import org.dockbox.selene.common.tasks.pipeline.exceptions.IllegalPipelineException;
...
public class ConvertiblePipeline<P, I> extends AbstractPipeline<P, I> {
   ...
   * @param throwable An nullable {@link Throwable} that may have been thrown while processing the
   *     input
   ...
   *
   * @param converter A non-null {@link Function} that takes in an {@code I} input and returns a
   ...
   * @param direction The {@link PipelineDirection} that the cancel behaviour needs to be passed
   *     along
   */
