...
package org.dockbox.selene.common.events.processors;

import org.dockbox.selene.api.annotations.event.processing.Getter;
import org.dockbox.selene.api.annotations.event.processing.Provided;
import org.dockbox.selene.api.annotations.event.processing.SkipIf;
import org.dockbox.selene.api.annotations.event.processing.UnwrapOrSkip;
import org.dockbox.selene.api.annotations.event.processing.WrapSafe;
...
public enum DefaultParamProcessors {
   ...
   * org.dockbox.selene.api.server.bootstrap.InjectableBootstrap#getInstance(Class,
  ...
  <A extends Annotation> DefaultParamProcessors(
      Class<A> annotationClass, AbstractEnumEventParamProcessor<A> processor) {
    this(annotationClass, EventStage.PROCESS, processor);
  }

  <A extends Annotation> DefaultParamProcessors(
      Class<A> annotationClass, EventStage stage, AbstractEnumEventParamProcessor<A> processor) {
    this.stage = stage;
    // TODO: Refactor to inner class
    this.processorSupplier =
        () ->
            new AbstractEventParamProcessor<A>() {
              @Override
