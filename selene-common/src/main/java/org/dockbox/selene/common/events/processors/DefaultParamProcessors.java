...
public enum DefaultParamProcessors
{
    ...
    /**
     * The processor definition for {@link Provided}. Tries to obtain a value through {@link org.dockbox.selene.api.server.bootstrap.InjectableBootstrap#getInstance(Class, InjectorProperty[])}.
