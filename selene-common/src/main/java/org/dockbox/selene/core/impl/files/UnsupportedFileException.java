...
/**
 A checked {@link Exception}, thrown if a file or {@link org.dockbox.selene.core.util.files.FileType} is not supported
 by a implementation.
 */
public class UnsupportedFileException extends Exception {
    /**
     ...
     @param fileType
     The filetype providing information about the unsupport file or {@link org.dockbox.selene.core.util.files.FileType}
     */
