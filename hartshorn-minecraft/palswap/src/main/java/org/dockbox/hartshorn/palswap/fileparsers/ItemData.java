...
public class ItemData {
    ...
    private Map<String, String> itemRegistry = HartshornUtils.emptyConcurrentMap();

    @Property(getter = "getBlockIdentifierIDs")
    private Map<String, String> blockIdentifierIds = HartshornUtils.emptyConcurrentMap();
