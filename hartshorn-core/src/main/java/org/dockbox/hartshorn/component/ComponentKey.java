...
public final class ComponentKey<T> implements Reportable {
     ...
     * attached to a scope, and do not indicate whether the component should be enabled. This method is useful for
    ...
    public static final class Builder<T> {
        ...
        /**
         * Sets whether the component should be enabled on provisioning. If the component is not enabled, it will not be
         * provisioned.
         *
         * @param enable whether the component should be enabled on provisioning
         * @return this builder
         */
