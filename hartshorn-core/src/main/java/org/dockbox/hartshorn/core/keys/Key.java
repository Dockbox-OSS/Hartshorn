...
public abstract class Key<K, A> {
     ...
     *
     * @return The transaction result containing information if a failure occurred.
     */
    public TransactionResult set(final K keyType, final A appliedValue) {
     ...
     */
    public Exceptional<A> get(final K keyType) {
