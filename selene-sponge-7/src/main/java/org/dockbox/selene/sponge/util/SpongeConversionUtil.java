...
public enum SpongeConversionUtil {
    ...
    @NotNull
    public static Text toSponge(org.dockbox.selene.api.i18n.text.Text message) {
        Iterable<org.dockbox.selene.api.i18n.text.Text> parts = message.getParts();
    ...
    private static Exceptional<org.spongepowered.api.text.action.ShiftClickAction<?>> toSponge(ShiftClickAction<?> action) {
        ...
        if (action instanceof ShiftClickAction.InsertText) {
            return Exceptional.of(TextActions.insertText(((org.dockbox.selene.api.i18n.text.Text) result).toPlain()));
        }
        return Exceptional.none();
    }
    ...
    private static Exceptional<org.spongepowered.api.text.action.HoverAction<?>> toSponge(HoverAction<?> action) {
        ...
        if (action instanceof HoverAction.ShowText) {
            return Exceptional.of(TextActions.showText(toSponge(((org.dockbox.selene.api.i18n.text.Text) result))));
        }
        return Exceptional.none();
    }
    ...
    public static Exceptional<Enchant> fromSponge(Enchantment enchantment) {
        try {
            ...
            Enchant enchant = new SimpleEnchant(org.dockbox.selene.server.minecraft.item.Enchantment.valueOf(id.toUpperCase()), level);
    ...
    @NotNull
    public static org.dockbox.selene.api.i18n.text.Text fromSponge(Text text) {
        ...
        org.dockbox.selene.api.i18n.text.Text t = org.dockbox.selene.api.i18n.text.Text.of(color + style + value);
    ...
    private static Exceptional<ShiftClickAction<?>> fromSponge(org.spongepowered.api.text.action.ShiftClickAction<?> shiftClickAction) {
        if (shiftClickAction instanceof InsertText) {
            return Exceptional.of(ShiftClickAction.insertText(org.dockbox.selene.api.i18n.text.Text.of(((InsertText) shiftClickAction).getResult())));
        }
        else return Exceptional.none();
    }
    ...
    private static String fromSponge(TextColor color) {
        return org.dockbox.selene.api.i18n.text.Text.sectionSymbol + textColors.getOrDefault(color, 'f') + "";
    }

    private static String fromSponge(TextStyle style) {
        final char styleChar = org.dockbox.selene.api.i18n.text.Text.sectionSymbol;
