...
package org.dockbox.hartshorn.nms.properties;
 ...
 * org.dockbox.hartshorn.nms.packets.NMSPacket NMSPackets}.
 *
 * @param <T>
...
public class NativePacketProperty<T extends Packet<?>> implements InjectorProperty<T> {
    ...
    public static final String KEY = "HartshornSpongeNativePacket";
    @Getter
