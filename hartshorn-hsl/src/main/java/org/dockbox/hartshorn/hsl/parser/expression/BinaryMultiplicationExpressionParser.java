 ...
 * expressions involving multiplication ({@code *}), division ({@code /}), and module
 * ({@code %}) operators.
 *
 * @since 0.7.0
 *
 * @author Guus Lieben
 */
public class BinaryMultiplicationExpressionParser extends AbstractBitwiseOrLogicalExpressionParser {
