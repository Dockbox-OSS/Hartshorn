...
public enum DiagnosticMessage {
    ...
    UNEXPECTED_NULL(1004, "Unexpected null character."),
    UNEXPECTED_DANGLING_NUMBER_SEPARATOR(1005, "Unexpected dangling number separator."),
    UNEXPECTED_EOT(1006, "Unexpected end of token. Expected any of: {0}."),
    INVALID_COMMENT_TOKEN_PAIR(1007, "Invalid comment token pair for comment type {0}."),
    UNSUPPORTED_COMMENT_TYPE(1008, "Unsupported comment type: {0}."),
    IDENTIFIER_STARTED_WITH_DIGIT(1009, "Identifiers cannot start with a digit."),
    ...
    ILLEGAL_NON_CLASS_SUPER(3016, "Cannot extend non-class type '{0}'."),
    ...
    UNSUPPORTED_UNARY(4010, "Unsupported unary operator: {0}"),
