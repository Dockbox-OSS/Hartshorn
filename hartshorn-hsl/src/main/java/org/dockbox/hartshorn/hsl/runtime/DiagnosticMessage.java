...
public enum DiagnosticMessage {
    ...
    UNSUPPORTED_CHILD(4010, Phase.INTERPRETING, "Unsupported child for {0}: {1}."),
    ...
    UNDEFINED_PROPERTY(4025, Phase.INTERPRETING, "Property '{0}' is not defined on {1}."),
    UNDEFINED_VARIABLE(4026, Phase.INTERPRETING, "Variable '{0}' is not defined."),
    UNDEFINED_PROPERTY_ACCESSOR(4027, Phase.INTERPRETING, "Could not register {0} for unknown property '{1}'."),
    INVALID_PROPERTY_ACCESS(4028, Phase.INTERPRETING, "Cannot {0} property '{1}' of {2} because it is not accessible from the current scope. The property is declared {3} and has {4}"),
    AMBIGUOUS_FUNCTION_IN_MODULE(4029, Phase.INTERPRETING, "Module '{0}' contains ambiguous function '{1}' which is already defined in the global scope."),
    UNEXPECTED_DEFAULT_CASE(4030, Phase.INTERPRETING, "Unexpected default case in non-switch statement."),
    TEST_CONDITION_FAILED(4031, Phase.INTERPRETING, "Test condition '{0}' failed with result: {1}"),
    NO_COMPATIBLE_LIBRARY_FUNCTION(4032, Phase.INTERPRETING, "No compatible library function found for {0} arguments."),
    MULTIPLE_COMPATIBLE_LIBRARY_FUNCTIONS(4033, Phase.INTERPRETING, "Multiple compatible library functions found for {0} arguments."),
    ILLEGAL_YIELD_IN_NON_GENERATOR(4034, Phase.INTERPRETING, "Cannot yield from non-generator function."),
    ILLEGAL_RETURN_IN_GENERATOR(4035, Phase.INTERPRETING, "Cannot return a value from generator function."),
