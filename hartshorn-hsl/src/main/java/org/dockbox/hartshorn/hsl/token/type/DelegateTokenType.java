...
/**
 * Represents a token type that delegates to another token type. This is useful for creating token
 * types that are based on other token types, but have additional behavior or metadata.
 *
 * @see TokenType
 * 
 * @since 0.6.0
