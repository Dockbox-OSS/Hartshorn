...
/**
 * A common library containing multiple {@link NativeFunctionStatement}s which can be invoked at
 * runtime. The module can optionally be loaded into the interpreter when a
...
public interface NativeModule extends ApplicationContextCarrier {
    ...
    /**
     * Call the native function with the given name and arguments. The arguments are passed as a
     * list of objects, which can be of any type. The return value is converted to an object of the
     * same type as the return type of the native function.
     *
     * @param at The token at which the call is made. This is used for error reporting.
     * @param interpreter The interpreter in which the call is made. This can be used to obtain
     * additional context.
    ...
    /**
     * Gets the supported functions of this module. Which functions are supported is determined by
     * the implementation, though it is typically expected that these methods are public.
     *
     * @param moduleName The name of the module. This is used to identify the module.
     * @param interpreter The interpreter in which the module is loaded. This can be used to obtain
     * additional context.
     *
