...
public class NativeLibrary implements CallableNode {
    ...
    public NativeLibrary(final NativeFunctionStatement declaration, final Map<String, NativeModule> externalModules) {
        this.declaration = declaration;
        this.externalModules = externalModules;
    }

    public NativeLibrary(final NativeFunctionStatement declaration, final String moduleName, final NativeModule externalModule) {
