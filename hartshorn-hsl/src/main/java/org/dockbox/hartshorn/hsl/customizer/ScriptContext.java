 ...
 * execution, and store its various executors. Everything but the original script can be customized
 * during the script's execution, though some runtimes may not support this.
 *
 * @since 0.4.12
 * 
 * @author Guus Lieben
...
public class ScriptContext extends DefaultApplicationAwareContext implements ResultCollector {
    ...
    /**
     * The original source code of the script. This source code is not modified during the execution
     * of the script, and can be used for error reporting and debugging purposes.
     *
    ...
    /**
     * The name of the script. This name is used for error reporting and debugging purposes. By
     * default, this name is "HSL Script &lt;hashcode&gt;", but it can be customized using
     * {@link #scriptName(String)}.
     *
    ...
    /**
     * The list of tokens generated by the lexer, or an empty list if the lexer has not yet been
     * run.
     *
    ...
    /**
     * Sets the list of tokens generated by the lexer. This should typically only be set by either
     * the lexer itself or the owning runtime, but is exposed for customization through
     * {@link CodeCustomizer customizers}.
     *
    ...
    /**
     * The token registry used by the lexer and parser to identify tokens. By default, this is a
     * {@link DefaultTokenRegistry}.
     *
    ...
    /**
     * The list of statements generated by the parser, or an empty list if the parser has not yet
     * been run.
     *
    ...
    /**
     * Sets the list of statements generated by the parser. This should typically only be set by
     * either the parser itself or the owning runtime, but is exposed for customization through
     * {@link CodeCustomizer customizers}.
     *
    ...
    /**
     * The list of comments found in the script, or an empty list if no comments were found.
     *
    ...
    /**
     * Sets the list of comments found in the script. This should typically only be set by the lexer
     * itself or the owning runtime, but is exposed for customization through
     * {@link CodeCustomizer customizers}.
     *
    ...
    /**
     * The lexer used to tokenize the script source code. This lexer is responsible for breaking the
     * source code into tokens, which are then parsed into statements.
     *
    ...
    /**
     * The parser used to parse the tokens into statements. This parser is responsible for
     * interpreting the tokens and creating an abstract syntax tree (AST).
     *
    ...
    /**
     * Sets the parser used to parse the tokens into statements. This parser is responsible for
     * interpreting the tokens and creating an abstract syntax tree (AST).
     *
    ...
    /**
     * The interpreter used to execute the script. This interpreter is responsible for executing the
     * statements in the abstract syntax tree (AST) and producing results.
     *
