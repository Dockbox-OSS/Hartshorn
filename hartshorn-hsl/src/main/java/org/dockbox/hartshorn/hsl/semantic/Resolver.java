...
public class Resolver {
    ...
    public Resolver currentClass(final ClassType currentClass) {
        this.currentClass = currentClass;
        return this;
    }

    public Resolver currentFunction(final FunctionType currentFunction) {
        this.currentFunction = currentFunction;
        return this;
    }

    public Resolver currentScopeType(final ScopeType currentScopeType) {
    ...
    public void resolveFunction(final ParametricExecutableStatement executable, final FunctionType type) {
    ...
    public void checkFinal(final Token name) {
