...
//
//    private static final Token BODY_START_TOKEN =
//        Token.of(DefaultTokenRegistry.createDefault().tokenPairs().block().open()).build();
//
//    @Test
...
//            Token.of(LiteralTokenType.TRUE).lexeme(String.valueOf(literalValue)).build();
...
//
//        Token conditionToken =
//            Token.of(LiteralTokenType.NUMBER).lexeme(String.valueOf(literalValue)).build();
...
//
//        Token conditionToken =
//            Token.of(LiteralTokenType.FALSE).lexeme(String.valueOf(literalValue)).build();
...
//        Interpreter interpreter = InterpreterTestHelper.interpreter();
//        Assertions.assertDoesNotThrow(() -> statementInterpreter.interpret(ifStatement,
//            interpreter));
//
...
//
//            DelegatingInterpreterVisitor interpreterVisitor =
//                (DelegatingInterpreterVisitor) visitor;
