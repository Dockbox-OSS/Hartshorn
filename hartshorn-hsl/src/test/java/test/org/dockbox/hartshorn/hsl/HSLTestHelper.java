...
import test.org.dockbox.hartshorn.hsl.ast.CaptureModule;
...
public class HSLTestHelper {
    ...
    public ResultCollector interpret() {
        ...
        List<Statement> statements = this.resolve();
        interpreter.interpret(statements);
        return interpreter.resultCollector();
    }

    public List<Statement> resolve() {
    ...
    public static class ExpressionTestHelper extends HSLTestHelper {
        ...
        public Expression parseExpression() {
            List<Statement> statements = this.parse();
            return this.parseExpression(statements);
        }

        protected Expression parseExpression(List<Statement> statements) {
        ...
        public <T extends Expression> T parseExpression(Class<T> type) {
            List<Statement> statements = super.resolve();
            Expression expression = this.parseExpression(statements);
        ...
        public <T extends Expression, R> R interpret(Class<T> type, ASTNodeInterpreter<R, T> interpreter) {
            T expression = this.parseExpression(type);
