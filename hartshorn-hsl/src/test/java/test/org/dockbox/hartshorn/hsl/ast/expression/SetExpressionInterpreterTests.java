...
//            new ExternalInstance(reference, externalClassRegistry.defineClass(typeView));
...
//            new LiteralExpression(propertyValue, propertyValue.literal());
//
//        Token propertyName = Token.of(LiteralTokenType.IDENTIFIER).lexeme("value").build();
//        SetExpression setExpression =
//            new SetExpression(variableExpression, propertyName, literalValue);
