...
/**
 * A binding function is used to bind a provider to a specific {@link ComponentKey}. This should be
 * used by {@link Binder}s to provide a fluent API for binding providers.
 *
...
public interface BindingFunction<T> {
     ...
     * processed. The higher the priority, the earlier the binding is processed. It remains up to
     * the {@link ComponentProvider} to determine how to process the bindings.
     *
    ...
    /**
     * Sets whether the result of the binding should be processed after initialization. This will
     * determine whether the result of the binding should be enhanced by
    ...
    /**
     * Binds to the given supplier, this will call the supplier every time it is requested.
     *
    ...
    /**
     * Binds to the given provider, this will call the provider every time it is requested.
     *
    ...
    /**
     * Binds to a supplier that will provide a lazy instance of the given type every time it is
     * requested. This will request the given supplier the first time it is requested and then
     * return the same instance every time it is requested.
     *
     * @param supplier The supplier to bind to
     *
     * @return The binder
    ...
    /**
     * Transforms the current binding function into a {@link CollectorBindingFunction} which allows
     * for collecting multiple bindings into a single {@link ComponentCollection}.
     *
