...
public interface ComponentKeyResolver {
    ...
    /**
     * Resolves the {@link ComponentKey} of the given view. The key will be scoped to the default
     * scope, which is typically the application scope.
     *
    ...
    /**
     * Resolves the {@link ComponentKey} of the given view. The key will be scoped to the given
     * scope.
     *
     * @param view the view to resolve the key for
