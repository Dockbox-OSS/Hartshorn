...
public class DarwinServer
    ...
    /**
     Looks up and registers all modules in {@link com.darwinreforged.servermodifications.modules}.
    ...
    public static ModuleRegistration registerModule(Class<? extends PluginModuleNative> module) {
        ...
        try {
            ...
            int permissionAmount = Permissions.getModulePermissions(module).length;
            getLogger().warn(String.format("- Registered %d permissions for module of type '%s'", permissionAmount, module.getSimpleName()));
