        ...
        if (optionalWeather.isPresent()) {
            ...
            switch (weather) {
                ...
                case RESET:
                    ...
                    if (PlayerWeatherCoreUtil.playerWeatherContains(uuid))
                        PlayerWeatherCoreUtil.removePlayerWeather(uuid);
            ...
            PlayerUtils.tell(player, Translations.UNKNOWN_ERROR
                    .ft("Valid weather types: rain, rainy, raining, snowing, snow, lightning, thunder, storm, lightningstorm, thunderstorm, reset, clear, sunny, undo"));
        }
