...
/**
 * A registry for converters. Converters can be registered with this registry to customize the
...
public interface ConverterRegistry {
    ...
    /**
     * Add a converter factory to the registry. The source and target types of the converter are
     * determined by the generic type parameters of the converter factory.
     *
     ...
     * the converter factory can be used to create a converter to convert a given source object to a
     * given target type in a {@link ConversionService}.
     *
     * @param sourceType the source type
     * @param converterFactory the converter factory to add
     * @param <I> the source type
    ...
    /**
     * Add a default value provider to the registry. The target type is to be used to determine
     * whether the provider can be used to provide a default value for a given target type in a
    ...
    /**
     * Add a default value provider factory to the registry. The target type of the provider is
     * determined by the generic type parameter of the provider factory.
     *
