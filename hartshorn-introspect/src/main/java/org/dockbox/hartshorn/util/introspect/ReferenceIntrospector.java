...
/**
 * An introspector is responsible for creating {@link TypeView}s from a given type reference. This
...
public interface ReferenceIntrospector {
    ...
    /**
     * Introspects the provided type reference and returns a {@link TypeView} that represents the
     * type. If the type represents a class that cannot be found, a {@link Void} type is returned.
     *
    ...
    /**
     * Introspects the provided type reference and returns a {@link TypeView} that represents the
     * type. If the type reference is a generic type, the type parameters are also introspected. If
     * the type reference is a wildcard type, a {@link WildcardTypeView} is returned. If the type
     * reference represents a class that cannot be found, a {@link Void} type is returned.
     *
