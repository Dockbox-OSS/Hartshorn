...
/**
 * An introspector to provide access to the annotations of an element. this is typically provided by
 * a {@link org.dockbox.hartshorn.util.introspect.view.AnnotatedElementView} implementation.
 *
...
public interface ElementAnnotationsIntrospector {
    ...
    /**
     * Returns all annotations that are present on the element, and that are annotated with the
     * provided annotation.
     *
     ...
     * @param annotations the annotations to check for
     *
     * @return {@code true} if the element is annotated with all the provided annotations,
     * {@code false} otherwise
     */
