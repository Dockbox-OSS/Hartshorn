...
/**
 * A method invoker is used to invoke a method on an instance. The method is provided as a
 * {@link MethodView} instance, which allows for easy access to the method's parameters and return
 * type.
 *
