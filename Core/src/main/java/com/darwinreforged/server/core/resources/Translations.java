...
public enum Translations {
    ...
    DAVE_TRIGGER_LIST_ITEM("$3 - $1{0}"),
    DAVE_TRIGGER_HOVER("$1Click to perform trigger"),
    ...
    WIKI_LIST_ROW(" $3- $1{0} $2[View]"),
    WIKI_SHARE_BUTTON("$2[Share $1'{0}'$2]"),
    ...
    WIKI_SHARED_USER("$2{0} $1shared the $2'{1}' $1entry with you"),
    WIKI_SHARED_WITH("$2You shared the $1'{0}' $2entry with $1{1}"),
