...
/**
 * A function that creates a proxy instance. This is used to allow for custom proxy
 * implementations.
 *
...
public interface ProxyConstructorFunction<T> {
    ...
    /**
     * Creates a new proxy instance. This will attempt to use the default constructor of the proxy
     * type.
     *
    ...
    /**
     * Creates a new proxy instance. This will attempt to use the given constructor of the proxy
     * type.
     *
