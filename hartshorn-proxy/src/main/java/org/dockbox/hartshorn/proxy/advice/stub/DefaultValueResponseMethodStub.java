...
/**
 * A {@link MethodStub} that returns the default value for the return type of the method. Primitive
 * types will be returned as non-null values, while non-primitive types will be returned as
 * {@code null}.
 *
