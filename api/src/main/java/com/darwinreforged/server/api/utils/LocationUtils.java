package com.darwinreforged.server.api.utils;
...
public class LocationUtils {
    ...
    public static Location<World> convertPlotsToSpongeLoc(com.intellectualcrafters.plot.object.Location p2Location) {
        ...
        else return new Location<>(world, p2Location.getX(), p2Location.getY(), p2Location.getZ());
    }

    public static com.intellectualcrafters.plot.object.Location convertSpongeToPlotsLoc(Location spongeLocation) {
    ...
    public static Plot getPlotFromSpongeLoc(Location<World> spongeLocation) {
