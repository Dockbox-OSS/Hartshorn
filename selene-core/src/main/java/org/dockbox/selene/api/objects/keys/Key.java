 ...
 * and retrieve values from types.
 *
 * @param <K>
...
public abstract class Key<K, A> {
    ...
    /**
     * Apply a given value of type parameter {@code A} to a given type constrained by type parameter
     * {@code K}.
     *
     * @param keyType
     ...
     *         org.dockbox.selene.api.i18n.common.ResourceEntry} if a failure occurred.
     */
     ...
     * when applying keys to supertypes which extend from multiple Keyholders, like {@link
     * org.dockbox.selene.api.objects.player.Player}. This method applies a constraint on the type, so
     ...
     * e.g. {@link Item} to a {@link org.dockbox.selene.api.objects.player.Player}.
     *
     * @param <T>
