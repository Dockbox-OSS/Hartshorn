...
public abstract class Key<K, A>
{
     ...
     *
     * @return The transaction result containing a {@link org.dockbox.selene.api.i18n.common.ResourceEntry} if a failure
     *         occurred.
     */
     ...
     * keys to supertypes which extend from multiple Keyholders, like {@link org.dockbox.selene.api.objects.player.Player}.
     ...
     * for e.g. {@link Item} to a {@link org.dockbox.selene.api.objects.player.Player}.
     *
     * @param <T>
