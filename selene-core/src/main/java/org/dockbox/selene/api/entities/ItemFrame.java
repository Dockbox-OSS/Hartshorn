...
public interface ItemFrame extends Entity<ItemFrame> {
   ...
   *
   * @param stack The {@link Item} to display.
   */
   ...
   *
   * @param rotation The {@link Rotation} of the displayed {@link Item}.
   */
   ...
   *
   * @param blockFace The {@link BlockFace} the item frame should be placed against.
   */
