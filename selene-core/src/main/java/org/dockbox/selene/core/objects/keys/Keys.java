...
public final class Keys
{
     ...
     * @return the removable key
     */
    public static <K, A> RemovableKey<K, A> checkedDynamicKeyOf(BiFunction<K, A, TransactionResult> setter, Function<K, Exceptional<A>> getter,
                                                                Consumer<K> remover)
    {
     ...
     * @return the removable key
     */
    public static <K, A> RemovableKey<K, A> unsafeCheckedDynamicKeyOf(BiFunction<K, A, TransactionResult> setter, CheckedFunction<K, A> getter,
                                                                      Consumer<K> remover)
    {
