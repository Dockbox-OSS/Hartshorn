...
public class MiscUtil {
    ...
    public String capitalize(String value) {
        return this.isEmpty(value) ? value : (value.substring(0, 1).toUpperCase() + value.substring(1));
    }
     ...
     * inverse of {@link MiscUtil#throwsException(CheckedRunnable)}.
     *
     * @param runnable
     *         The function to run
     *
     * @return true if the function does not throw a exception
     * @see MiscUtil#throwsException(CheckedRunnable)
     */
     ...
     * Acts as inverse of {@link MiscUtil#throwsException(CheckedRunnable, Class)} )}.
     *
     * @param runnable
     *         The function to run
     * @param exception
     ...
     *
     * @return true if the function does not throw a exception
     * @see MiscUtil#throwsException(CheckedRunnable, Class)
     */
